...
/**
 * Optional - static 메소드와 instance 메소드
 */
public class Chapter7Section1 {
    public static void main(String[] args) {
        ...
        System.out.println("Same? : " + userEquals(user2,user1)); // user1, user2 인 경우 NPE 출력

        String someEmail = "some@email.com";
        String nullEmail = null;

        Optional<String> maybeEmail = Optional.of(someEmail);
        Optional<String> maybeEmail2 = Optional.empty(); // null instance 생성
        ...
        //String email2 = maybeEmail2.get(); // null이라서 Error 던짐
        maybeEmail2.ifPresent(System.out::println);
        if(maybeEmail2.isPresent())
            System.out.println(maybeEmail2.get());

        String defaultEmail = "default@email.com";
        String email3 = maybeEmail2.orElse(defaultEmail); // maybeEmail2 있으면 maybeEmail2리턴, 비어 있다면 defaultEmail 리턴
